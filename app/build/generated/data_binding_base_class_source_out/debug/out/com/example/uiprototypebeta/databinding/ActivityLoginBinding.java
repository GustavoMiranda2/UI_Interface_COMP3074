...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull NestedScrollView rootView, @NonNull MaterialButton btnGuest,
      ...
      @NonNull LinearLayout layoutSignUp, @NonNull TextInputLayout tilEmail,
      @NonNull TextInputLayout tilPassword, @NonNull TextView tvHint,
      @NonNull TextView tvSignUpPrompt, @NonNull TextView tvSubtitle, @NonNull TextView tvTitle) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((NestedScrollView) rootView, btnGuest, btnSignIn, btnSignUp,
          etEmail, etPassword, layoutSignUp, tilEmail, tilPassword, tvHint, tvSignUpPrompt,
          tvSubtitle, tvTitle);
    }
